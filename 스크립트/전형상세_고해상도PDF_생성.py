...
UNIS = [
 ...
 ("⑤ 한경국립대", "모집요강/한경국립대_2027_수시모집요강.pdf", [
   ...
   (44, "학생부 반영방법① — 전형유형별 성적반영 배점표(Ⅴ)"),
   (45, "학생부 반영방법② — 반영교과·학년별비율 · 석차등급 산출방법"),
   (46, "학생부 반영방법③ — 비교내신(학생부 특이자) 반영방법·산출식"),
   (47, "학생부 반영방법④ — 학생부교과 성적 산출 예시"),
 ...
 ("⑦ 국립공주대", "모집요강/국립공주대_2027_수시모집요강.pdf", [
   (33, "학생부종합(일반전형) — 전형방법·서류평가 배점표 및 평가기준"),
   (50, "학생부교과(일반전형) — 전형방법·학생부 성적 반영방법 요약"),
   (80, "학생부 반영방법① — 학종 정성평가 안내 · 교과성적 산출공식"),
   (81, "학생부 반영방법② — 검정고시·외국고 변환표 · 출결·가산점"),
 ]),
]
